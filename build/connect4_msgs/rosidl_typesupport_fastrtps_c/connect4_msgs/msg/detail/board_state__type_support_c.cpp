...
#include "connect4_msgs/msg/detail/board_state__rosidl_typesupport_fastrtps_c.h"
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cells
  {
    ...
    if (ros_message->cells.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->cells);
    }
...
static size_t _BoardState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_connect4_msgs__msg__BoardState(
