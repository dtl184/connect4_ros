...
#include "connect4_msgs/msg/detail/board_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  connect4_msgs::msg::BoardState & ros_message)
{
  // Member: cells
  {
    cdr >> ros_message.cells;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = connect4_msgs::msg::BoardState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const connect4_msgs::msg::BoardState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<connect4_msgs::msg::BoardState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BoardState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const connect4_msgs::msg::BoardState *>(
...
static size_t _BoardState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BoardState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BoardState__callbacks = {
  "connect4_msgs::msg",
  "BoardState",
...
static rosidl_message_type_support_t _BoardState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BoardState__callbacks,
...
{
  return &connect4_msgs::msg::typesupport_fastrtps_cpp::_BoardState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, connect4_msgs, msg, BoardState)() {
  return &connect4_msgs::msg::typesupport_fastrtps_cpp::_BoardState__handle;
}
